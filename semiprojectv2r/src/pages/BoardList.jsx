            ...
            <table className="table table-striped">
                ...
                <tr>
                    ...
                    <td colSpan="3" className="text-end">
                        <button type="button" className="btn btn-primary" id="newbdbtn"><i className="fas fa-pen"></i> 글쓰기</button>
                    </td>
                </tr>
